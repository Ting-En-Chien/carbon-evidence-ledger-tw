...
from carbon_ledger.ui.tutorial import get_tutorial_copy, tutorial_step_texts
...
def test_tutorial_is_centered_medium_dialog() -> None:
...
def test_tutorial_is_simple_three_step_onboarding() -> None:
...
def test_scope_3_unsupported_is_not_zero() -> None:
    ...
    dash = (REPO_ROOT / "app_pages/dashboard.py").read_text(encoding="utf-8")
    assert "dash.scope3_short" in dash

...
def render_glossary_popover(lang: str) -> None:
    """Render glossary as a compact popover (admin diagnostics only).

    Customer chrome no longer exposes a global glossary control. Field-level
    explanations use the contextual "?" help beside the field.
    """
